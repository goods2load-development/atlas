...
const CompanyStory = () => {
  return (
    <section className="w-full flex flex-col gap-[40px] py-[104px]">
      <div className="flex flex-col gap-[16px] text-start text-black px-[72px]">
      ...
      <div className="flex flex-row gap-[40px] relative px-[72px]">
        <div className="absolute inset-0 top-[47px] h-fit z-[-1] ml-[-5%] overflow-hidden flex flex-row gap-1 right-0 left-0">
          <Image
