...
const CompanyOurStory = () => {
  return (
    <section className="w-full flex flex-col items-center gap-[16px] py-[104px] px-[72px] bg-divide-pattern bg-cover bg-center">
      <h1 className="text-center font-normal text-[48px]/[57.6px] italic">
        Our <span className="font-light not-italic">story</span>
      </h1>
      <p className="text-center font-normal text-[18px]/[25px]">
