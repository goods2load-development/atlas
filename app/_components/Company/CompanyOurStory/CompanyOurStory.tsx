...
const CompanyOurStory = () => {
  return (
    <section className="w-full flex flex-col items-center gap-[16px] py-16 sm:py-[104px] sm:px-[72px] bg-divide-pattern-mobile sm:bg-divide-pattern bg-cover bg-center px-4">
