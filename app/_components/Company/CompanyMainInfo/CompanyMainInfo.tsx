...
const CompanyMainInfo = () => {
  return (
    <section className="w-full flex flex-col sm:flex-row gap-[56px] sm:pt-[104px] pt-20 px-5 sm:px-[72px]">
      ...
      <div className="sm:w-1/2 flex flex-col justify-start gap-[16px] order-1">
