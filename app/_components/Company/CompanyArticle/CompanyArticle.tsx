...
const CompanyArticle = () => {
  return (
    <section className="w-full sm:flex flex-col gap-[64px] px-5 sm:px-[72px]">
      <div className="w-full sm:flex flex-row items-center gap-[56px]">
      ...
      <div className="w-full flex sm:items-center flex-col sm:flex-row sm:gap-[56px] gap-2">
        <div className="sm:w-1/2 flex flex-col justify-start gap-[16px] order-2 sm:order-1">
          <p className="text-black font-normal sm:text-[18px]/[25px] text-left sm:mb-0">
        ...
        <div className="sm:w-1/2 rounded-lg overflow-hidden order-1 sm:order-2 mt-10 sm:mt-0">
          <Image
            className="w-full rounded-lg translate-y-[-10%]"
            src={thereIsNotImg}
            alt={"img2"}
