"use client";
import { type FC, memo, useEffect, useState, SetStateAction } from "react";
      ...
      <div className="flex flex-col w-full items-center justify-center pt-[47px] bg-hero-pattern bg-cover bg-center text-white text-center">
        ...
        <div className="flex w-fit pb-[190px]">
          <div
            ...
            onClick={() => handleSetQuery("company")}
          >
            Company
            {currentScreen === "company" && (
              <div
                className={`h-[2px] w-full bg-gradient-to-r from-transparent via-white absolute bottom-0`}
              ></div>
            )}
          </div>
          <div
