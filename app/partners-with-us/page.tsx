    ...
    <LoyaltAllWrapper>
        <div className="md:flex gap-2 justify-between">
            <div className="px-4 xl:pt-[169px] pt-10 md:pt-20 lg:w-[592px] xl:ml-[72px] md:ml-10 2xl:mx-auto md:pb-4 pb-12 text-center md:text-left ml-0">
                <h3 className="text-[34px]/[37.6px] xl:text-[48px]/[57.6px] font-light text-black">Reach <i className="font-normal">millions of business searching</i> on how to ship their goods and <i className="font-normal bg-[#FEF1DF]">increase their business</i></h3>
                <p className="mt-6 text-[18px]/[26px]">Be the copilot you would aspire to have beside in your journey.</p>
            ...
            <Image width={720} height={750} src={PartnersWithUsImg} alt="Partners with us" className="w-full md:w-[720px]"/>
        </div>
    </LoyaltAllWrapper>
  );
};
