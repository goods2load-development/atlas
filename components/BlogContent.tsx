...
const BlogContent: React.FC<BlogContentProps> = ({ content, onHeadingsParsed }) => {
  const [parsedContent, setParsedContent] = useState<string>("");

  useEffect(() => {
    const parser = new DOMParser();
    const doc = parser.parseFromString(replaceH1Duplicate(content), "text/html");
  ...
  return (
    <div className="blog-content md:w-3/4 p-4">
